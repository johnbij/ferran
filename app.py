...
# GitHub Contents API has strict size limits; keep a safe margin under 100MB.
...
def get_repo():
    ...
    repo_name = st.secrets["github"]["repo"]  # e.g. "johnbij/ferran"
    g = Github(token)
...
st.caption("Se guardará en la carpeta **recién subidos/** del repositorio.")
